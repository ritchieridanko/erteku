...
type AuthServiceClient interface {
	...
	IsEmailAvailable(ctx context.Context, in *EmailCheckRequest, opts ...grpc.CallOption) (*EmailCheckResponse, error)
}
...
func (c *authServiceClient) IsEmailAvailable(ctx context.Context, in *EmailCheckRequest, opts ...grpc.CallOption) (*EmailCheckResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type AuthServiceServer interface {
	...
	IsEmailAvailable(context.Context, *EmailCheckRequest) (*EmailCheckResponse, error)
...
func (UnimplementedAuthServiceServer) IsEmailAvailable(context.Context, *EmailCheckRequest) (*EmailCheckResponse, error) {
...
func _AuthService_IsEmailAvailable_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).IsEmailAvailable(ctx, req.(*EmailCheckRequest))
	}
	return interceptor(ctx, in, info, handler)
}
